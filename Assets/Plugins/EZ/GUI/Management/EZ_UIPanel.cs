...
public class EZ_UIPanel : UIPanelBase
{
	//------------------------------------------
	// Transition stuff:
	//------------------------------------------
	...
	static public EZ_UIPanel Create(string name, Vector3 pos)
	{
		GameObject go = new GameObject(name);
		go.transform.position = pos;
		return (EZ_UIPanel)go.AddComponent(typeof(EZ_UIPanel));
	}
	...
	/// <returns>Returns a reference to the component.</returns>
	static public EZ_UIPanel Create(string name, Vector3 pos, Quaternion rotation)
	{
		GameObject go = new GameObject(name);
		go.transform.position = pos;
