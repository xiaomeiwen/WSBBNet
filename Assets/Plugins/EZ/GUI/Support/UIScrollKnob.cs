...
/// </summary>
public class UIScrollKnob : EZ_UIButton
{
	protected Vector3 origPos;		// The starting position of the knob
	protected EZ_UISlider slider;		// The object the knob will be scrolling
	...
	public void SetSlider(EZ_UISlider s)
	{
		slider = s;
	}

	/// <summary>
	/// Returns a reference to the associated EZ_UISlider control.
	/// </summary>
	/// <param name="s">The EZ_UISlider control of which this knob is part.</param>
	public EZ_UISlider GetSlider()
	{
		return slider;
	}
